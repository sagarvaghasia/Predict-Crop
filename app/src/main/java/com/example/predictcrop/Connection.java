...
public class Connection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rcieve=(Button)findViewById(R.id.button7);
        ...
        rcieve.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        predict.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent p = new Intent(Connection.this, Predictcrop.class);
                p.putExtra("p", incomingMessage);
                startActivity(p);
            }
        });
    }
